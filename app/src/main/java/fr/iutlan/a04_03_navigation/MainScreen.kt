...
import fr.iutlan.a04_03_navigation.navigation.SetupNavGraph
...
fun TopBar(navController: NavController){
    ...
    NavigationBar {
        AddItem(screen = Screen.Home,currentDestination=currentDestination,navController=navController)
    }
}
